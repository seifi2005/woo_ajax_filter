...
* برای تغییر taxonomy نوع کیف: خط 117 در فایل اصلی
* برای تغییر حداکثر قیمت: خط 85 در filter.js
* برای تغییر تعداد محصولات: خط 143 در فایل اصلی
